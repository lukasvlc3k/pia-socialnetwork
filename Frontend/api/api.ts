...
export const ChatControllerApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        getChatMessages: async (userId: number, withUserId: number, count?: number, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'userId' is not null or undefined
            assertParamExists('getChatMessages', 'userId', userId)
...
export const ChatControllerApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async getChatMessages(userId: number, withUserId: number, count?: number, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<ChatMessageDto>>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.getChatMessages(userId, withUserId, count, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
    }
};
...
export const ChatControllerApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        getChatMessages(userId: number, withUserId: number, count?: number, options?: any): AxiosPromise<Array<ChatMessageDto>> {
            return localVarFp.getChatMessages(userId, withUserId, count, options).then((request) => request(axios, basePath));
        },
    };
};
...
export class ChatControllerApi extends BaseAPI {
     ...
     */
    public getChatMessages(userId: number, withUserId: number, count?: number, options?: AxiosRequestConfig) {
        return ChatControllerApiFp(this.configuration).getChatMessages(userId, withUserId, count, options).then((request) => request(this.axios, this.basePath));
    }
}
...
export const UsersControllerApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
        ...
        searchRelevantUsers: async (search: string, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            ...
            const localVarPath = `/users/results`;
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
            let baseOptions;
            if (configuration) {
